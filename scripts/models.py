...
def get_linear_weights(X, y, alpha=0.01):
    ...
    return torch.linalg.solve(A, Xy).mT
...
class Model(nn.Module):
    def __init__(self, embed_dim=256,
        ...
        self.embed_c = nn.Sequential(nn.LazyLinear(embed_dim), nn.ReLU()) #this is what i have to modify
        #pytoch geometrics get it# this is what I have to replace  this is a linear 
    #modify train model with custom dataset that gives me the grapshs 
    #modify the get data 
